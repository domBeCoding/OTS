    ...
    public void selectAccountMenuPrompt() {
        ...
        if(sessionAccount instanceof Customer){
            ...
            while(loggedIn){
                ...
                String option = Utility.outputMenuAndReadResponse(customerOptions);
            ...
            while(loggedIn){
                String option = Utility.outputMenuAndReadResponse(ticketAgentOptions);
            ...
            while(loggedIn){
                String option = Utility.outputMenuAndReadResponse(venueManagerOptions);
